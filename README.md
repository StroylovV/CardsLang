...
После запуска проекта интерактивная документация будет доступна по следующим адресам:

    Swagger UI (рекомендуется): http://127.0.0.1:8000/docs — для тестирования эндпоинтов в реальном времени.

    ReDoc: http://127.0.0.1:8000/redoc — подробная техническая документация схем.
📂 Структура проекта
   ```bash
   app/
├── api/          # Роутеры (users, dictionaries, words)
├── core/         # Конфигурация, безопасность, JWT
├── db/           # Инициализация асинхронного движка БД
├── models/       # SQLAlchemy модели
├── schemas/      # Pydantic схемы (DTO)
├── service/      # Бизнес-логика (CRUD сервисы)
